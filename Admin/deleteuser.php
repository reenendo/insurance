...
{
$cn=makeconnection();
$s="select * from clients where Clientid='" .$_POST["t4"] ."'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
...
<tr><td class="lefttxt">First Name</td><td><input type="text"  value="<?php if(isset($_POST["show"]))
{ echo $Firstname ;} ?> " name="t1" required /></td></tr>
<tr><td class="lefttxt">Last Name</td><td><input type="text"  value="<?php if(isset($_POST["show"]))
{ echo $Lastname ;} ?> " name="t2" required /></td></tr>
<tr><td class="lefttxt">Phone Number</td><td><input type="text"  value="<?php if(isset($_POST["show"]))
{ echo $Phno ;} ?> " name="t3" required /></td></tr>
<tr><td class="lefttxt">Age</td><td><input type="text"  value="<?php if(isset($_POST["show"]))
{ echo $Age ;} ?> " name="t5" required /></td></tr>
