...
if(isset($_POST["sbmt"]))
{
	...
	mysqli_query($cn,$s);
	mysqli_close($cn);
	header("location: addcategory.php?note=success");
}
?>
...
<tr><td class="lefttxt">Category Name</td><td><input type="text" name="t1" required pattern="[a-zA-z _]{3,20}" 
title"Please Enter Only Characters between 3 to 10 for Category Name" /></td></tr>
