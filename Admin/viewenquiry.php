...
<form method="post">
<table border="0" width="800px" height="300px" align="center" class="tableshadow">
<tr><td class="toptd">View Enquirys</td></tr>
<tr><td align="center" valign="top" style="padding-top:10px;">
<table border="0" align="center" width="95%">
<tr>
<td style="font-size:15px; padding:5px; font-weight:bold;" >Contact Id</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">Contact Name</td>
...
while($data=mysqli_fetch_array($result))
	{
		...
		<td style=' width:100px  padding:5px;'>$data[1]</td>
